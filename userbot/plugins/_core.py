...
async def unload(event):
    ...
    try:
        ...
        qwe = await eor(event, f"TSF USERBOT Has Successfully unloaded {shortname}")
    except Exception as e:
        await qwe.edit(
            "Tsf userbot  has Successfully unloaded {shortname}\n{}".format(shortname, str(e))
        )
...
async def load(event):
    ...
    try:
        ...
        await qwe.edit(
            f"TSF USERBOT could not load {shortname} because of the following error.\n{str(e)}"
        )
